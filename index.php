...
<head>
    <title>新年好</title>
    <meta itemprop="name" content="吃掉福字" />
    <meta itemprop="description" content="新年好！" />
    <meta charset="utf-8" />
    ...
    <div id="welcome" class="SHADE BOX-M">
        ...
        <div class="FILL BOX-M" style="position:absolute;top:0;left:0;right:0;bottom:0;z-index:5;">
            <div style="margin:0 8% 0 9%;">
                <div style="font-size:2.6em; color:#FEF002;">新年快乐！</div><br />
                ...
                <div id="btn_group" style="display: block;">
                    ...
                    <br /><br />
                    <button type="button" class="btn btn-secondary btn-lg" onclick="show_setting()"></button>
                </div>
                <div id="setting" style="display: none;">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" id="username" class="form-control" maxlength=8 placeholder=" ">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1"></span>
                        </div>
                        <input type="text" id="message" class="form-control" maxlength=50 placeholder=" ">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1"></span>
                    ...
                    <button type="button" class="btn btn-secondary btn-lg" onclick="show_btn();save_cookie();"></button>
                </div>
            </div>
        </div>
    </div>
